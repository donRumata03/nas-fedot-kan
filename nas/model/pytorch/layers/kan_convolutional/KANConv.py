...
from nas.model.pytorch.layers.kan_convolutional import convolution
...
class KAN_CrossConvolution(torch.nn.Module):
    def __init__(
            self,
            in_channels: int,
            out_channels: int,
        ...
        self.conv = KANLinear(
            in_features=math.prod(kernel_size) * in_channels,
